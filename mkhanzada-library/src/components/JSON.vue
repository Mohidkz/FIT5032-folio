  ...
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        ...
        :key="author.id"
        :style="{ backgroundColor: highlight? colourAuth: '' }"
      >
        {{ author.id }} {{ author.name }}
      </li>

      </ul>
      <button @click="highlight=!highlight">highlight authors</button>
      <p>{{ highlight?"toggled":"nottoggled" }}</p>
    </section>
  </div>
</template>
